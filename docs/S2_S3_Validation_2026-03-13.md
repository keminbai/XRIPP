...
本文档主体记录的是 2026-03-13 当晚的验证结果，保留历史原貌；但截至 2026-03-14，当前仓库与后续执行记录已有四点需要修正：
...
- 当前降级页面总数应为 **10 页**
- 其中 session-only 为 **9 页**
- 纯信息展示为 **1 页**
- `pricing.vue` / `profit.vue` / `business/*` / `system/settings|login-config` 当前状态应改为“真实后端已接入，待浏览器联调补留痕”
